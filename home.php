...
try {
    // جلب الإحصاءات العامة من قاعدة البيانات
    $total_students = $pdo->query("SELECT COUNT(*) FROM users WHERE role = 'student'")->fetchColumn();
    $total_lectures = $pdo->query("SELECT COUNT(*) FROM lectures WHERE status = 'approved'")->fetchColumn();
    $total_exams = $pdo->query("SELECT COUNT(*) FROM exams")->fetchColumn();
    // -- الإضافة الجديدة هنا --
    $total_posts = $pdo->query("SELECT COUNT(*) FROM posts WHERE status = 'approved'")->fetchColumn();

} catch (PDOException $e) {
    // في حال حدوث خطأ، يتم تعيين قيم افتراضية
    $total_students = 0;
    $total_lectures = 0;
    $total_exams = 0;
    $total_posts = 0; // القيمة الافتراضية للمنشورات
}
?>
<!DOCTYPE html>
        ...
        <div class="hero-content">
            ...
            <div class="cta-buttons">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <a href="student/profil.php" data-aos="fade-up" data-aos-delay="100">الذهاب إلى ملفي الشخصي</a>
                <?php else: ?>
                    <a href="login.php" data-aos="fade-up" data-aos-delay="100">تسجيل الدخول</a>
                    <a href="signup.php" class="secondary" data-aos="fade-up" data-aos-delay="200">إنشاء حساب جديد</a>
                <?php endif; ?>
            </div>
        </div>
    </section>
    ...
    <section class="stats-section">
        ...
        <div class="stats-grid">
            <div class="stat-item" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="stat-number" data-target="<?php echo $total_students; ?>">0</div>
                <div class="stat-label">طالب مسجل</div>
            </div>
            <div class="stat-item" data-aos="fade-up" data-aos-delay="200">
                <i class="fa-solid fa-book-open-reader"></i>
                <div class="stat-number" data-target="<?php echo $total_lectures; ?>">0</div>
                <div class="stat-label">محاضرة منشورة</div>
            </div>
            <div class="stat-item" data-aos="fade-up" data-aos-delay="300">
                <i class="fa-solid fa-file-signature"></i>
                <div class="stat-number" data-target="<?php echo $total_exams; ?>">0</div>
                <div class="stat-label">امتحان مرفوع</div>
            </div>
            <div class="stat-item" data-aos="fade-up" data-aos-delay="400">
                <i class="fa-solid fa-comments"></i>
                <div class="stat-number" data-target="<?php echo $total_posts; ?>">0</div>
