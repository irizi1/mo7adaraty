...
// ==========================================================
// 2. جلب التعليقات من قاعدة البيانات
// ==========================================================
try {
    $stmt = $pdo->prepare("
    ...
    if (count($comments) > 0) {
        foreach ($comments as $comment) {
            ...
            if (isset($_SESSION['user_id']) && $_SESSION['user_id'] == $comment['user_id']) {
                ...
                echo '  <a href="../comments/delete_comment.php?id=' . $comment['comment_id'] . '" class="delete-comment-btn" onclick="return confirm(\'هل أنت متأكد من حذف هذا التعليق؟\');">حذف</a>';
                echo '</div>';
            }
